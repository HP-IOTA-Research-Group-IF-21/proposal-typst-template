...
#par(leading: 1em, spacing: 2em, justify: true, [
  #figure(
    table(
      columns: (1fr, 2fr),
      align: (left, left),
...
#figure(image("../../../assets/images/Iota_logo.png", width: 80%), caption: [ch1])<ch-image-3>
#figure(image("../../../assets/images/Iota_logo.png", width: 80%), caption: [ch1])<ch-image-4>

Contoh kode `helloworld`.
@ch-code-1
@ch-code-2
@ch-code-3

#figure(raw("print(\"Hello, World!\")", lang: "python", block: true), caption: [ch1])<ch-code-1>
#figure(raw("print(\"Hello, World!\")
print(1+2)
print(9%2)", lang: "python", block: true), caption: [ch1])<ch-code-2>

// bug: block styling and figure not working for overly long raw text
#figure(
  raw(
