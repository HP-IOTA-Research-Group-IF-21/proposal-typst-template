...
== Rumusan Masalah <main>

Rumusan masalah yang baik memiliki struktur sebagai berikut:
+ Penjelasan ringkas tentang kondisi/situasi yang ada sekarang terkait dengan topik utama yang dibahas Tugas Akhir.
+ Pokok persoalan dari kondisi/situasi yang ada, dapat dilihat dari kelemahan atau kekurangannya. Bagian ini merupakan inti dari rumusan masalah.
+ Elaborasi lebih lanjut yang menekankan pentingnya untuk menyelesaikan pokok persoalan tersebut.
+ Usulan singkat terkait dengan solusi yang ditawarkan untuk menyelesaikan persoalan.
...
== Tujuan dan Ukuran Keberhasilan Pencapaian <main>
